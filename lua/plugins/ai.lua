...

	{
		...
		config = function(_, opts)
			...
			vim.keymap.set("i", opts.keymaps.accept_suggestion, function()
				...
				if not vim.b.supermaven_suggestion_shown or vim.b.supermaven_suggestion_shown == 0 then
					return vim.api.nvim_feedkeys(vim.api.nvim_replace_termcodes(opts.keymaps.accept_suggestion, true, false, true), "n", false)
				end
