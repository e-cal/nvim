...
_G.packer_plugins = {
  ...
  ["cmp-nvim-ultisnips"] = {
    loaded = true,
    path = "/home/ecal/.local/share/nvim/site/pack/packer/start/cmp-nvim-ultisnips",
  ...
  ["cmp-spell"] = {
    loaded = true,
    path = "/home/ecal/.local/share/nvim/site/pack/packer/start/cmp-spell",
  ...
  ["format.nvim"] = {
    loaded = true,
    path = "/home/ecal/.local/share/nvim/site/pack/packer/start/format.nvim",
  ...
  ["lsp_signature.nvim"] = {
    loaded = true,
    path = "/home/ecal/.local/share/nvim/site/pack/packer/start/lsp_signature.nvim",
  ...
  sonokai = {
    loaded = true,
    path = "/home/ecal/.local/share/nvim/site/pack/packer/start/sonokai",
